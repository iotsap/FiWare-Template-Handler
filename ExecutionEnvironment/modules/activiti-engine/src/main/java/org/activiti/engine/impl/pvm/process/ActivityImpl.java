...
public class ActivityImpl extends ScopeImpl implements PvmActivity, HasDIBounds {
  ...
  protected List<PhysicalAssociation> physicalAssociations = new ArrayList<PhysicalAssociation>();
  ...
  protected void setPhysicalAssociations(List<PhysicalAssociation> physicalAssociations) {
    this.physicalAssociations = physicalAssociations;
  }
