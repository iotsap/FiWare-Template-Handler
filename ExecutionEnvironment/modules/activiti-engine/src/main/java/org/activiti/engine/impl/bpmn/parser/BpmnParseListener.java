...
public interface BpmnParseListener {
  ...
  void parseActuationTask(Element actuationTaskElement, ScopeImpl scope, ActivityImpl activity);
  void parseSensingTask(Element sensingTaskElement, ScopeImpl scope, ActivityImpl activity);
