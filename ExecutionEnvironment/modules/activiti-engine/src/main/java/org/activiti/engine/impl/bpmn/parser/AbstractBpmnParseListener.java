...
public class AbstractBpmnParseListener implements BpmnParseListener {
  ...
  public void parseActuationTask(Element actuationTaskElement, ScopeImpl scope, ActivityImpl activity) {
  }

  public void parseSensingTask(Element sensingTaskElement, ScopeImpl scope, ActivityImpl activity) {
  }
