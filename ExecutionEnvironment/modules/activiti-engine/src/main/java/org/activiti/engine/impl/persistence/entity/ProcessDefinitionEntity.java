...
public class ProcessDefinitionEntity extends ProcessDefinitionImpl implements ProcessDefinition, PersistentObject {
  ...
  public ExecutionEntity createProcessInstance(String businessKey, ActivityImpl initial) {
    ...
    for (ActivityImpl activity : activities) {
      ...
      if (activityBehavior instanceof SensingTaskActivityBehavior) {
        List<String> physicalEntityNames = new ArrayList<String>();
        for (PhysicalAssociation physicalAssociation : activity.getPhysicalAssociations()) {
          ...
          physicalEntityNames.add(physicalEntity.getName());
        }
      }
    }
