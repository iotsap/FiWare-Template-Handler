...
Signavio.Const.META_TYPES.STENCILSET = [{
    ...
    type: "MetaDataGlossaryLink",
    asList: true
}, "MetaDataDate", "MetaDataNumberInfo", "MetaDataEnum", {
    type: "MetaDataUrl",
    asList: true
}, "MetaDataBoolean"];
...
Ext.form.ComboBoxMulti = function (a) {
    ...
    this.defaultAutoCreate = {
        tag: a.renderAsTextArea ? "textarea" : "input",
        autocomplete: "off"
    };
...
Ext.form.DataStoreComboBox = Ext.extend(Ext.form.ComboBox, {
    typeAhead: true,
    mode: "local",
    minChars: 0,
    triggerAction: "all",
...
Ext.DataView.LabelEditor = function (a, b) {
    Ext.DataView.LabelEditor.superclass.constructor.call(this, b || new Ext.form[a.tag === "textarea" ? "TextArea" : "TextField"]({
        allowBlank: false,
        grow: a.tag === "textarea" && a.grow !== false
    }), a)
};
Ext.extend(Ext.DataView.LabelEditor, Ext.Editor, {
    ...
    initEditor: function () {
        ...
        this.view.getEl().on("mouseover", this.onMouseOver, this, {
            delegate: this.labelSelector
        });
        this.view.getEl().on("mouseout", this.onMouseOut, this, {
            delegate: this.labelSelector
        })
    },
...
Signavio.Extensions.AddedPanel = function (a) {
    ...
    if (a.onDelete instanceof Function) {
        this.plugins = [new Signavio.Extensions.HoverButton({
            selector: "div.x-panel-added-item",
...
Ext.extend(Signavio.Extensions.AddedPanel, Ext.Panel, {
    itemTpl: new Ext.XTemplate('<div class="x-panel-added-list">', '<tpl for=".">', '<div class="x-panel-added-item" rel="{id}"><img src="{icon}"/><span>{name}</span></div>', "</tpl>", "</div>"),
    icon: Signavio.Config.EXPLORER_PATH + "/src/img/famfamfam/user.png",
    cls: "x-panel-added",
    width: 200,
    isFormField: true,
    originalValue: null,
    ...
    onRender: function () {
        ...
        this.textField = new Ext.form.ComboBox(Ext.apply({
            store: this.store,
            hidden: this.hideAddField,
            width: this.width,
            minListWidth: 200,
            listClass: "x-panel-added-cb-list",
            displayField: "rep.name||rep.mail||rep.principal",
            value: "",
            tpl: a,
            itemSelector: "div.search-item",
            blankText: "Name",
            selectOnFocus: true,
            triggerClass: "x-panel-added-trigger",
            renderTo: this.body,
            allowBlank: true,
            mode: "local",
            tabIndex: 1000,
    ...
    setValue: function (b, d, f) {
        ...
        var e = b.map(function (g, a) {
            return {
                icon: this.icon,
                name: (this.parseText ? this.parseText(g, f[a]) : false) || g.name || g,
                id: f.length > a ? (f[a].get ? f[a].get("href") : f[a].href) : null
            }
...
new function () {
    function a(m, b, e, d) {
        ...
        var h = new Ext.tree.TreeNode({
            text: "",
            leaf: false,
            childLeaf: m.treeChildLeaf || false,
            cls: "folder",
            expanded: true,
            dataField: m.dataField || "rep.name",
            filterFn: j,
            childCls: m.treeChildCls || "user",
            recordRel: m.recordRel || "info",
            identifier: m.treeRootIdentifier,
            parseText: m.parseText instanceof Function ? m.parseText : undefined
        });
        var l = new Signavio.Extensions.TreePanel({
            sortingFn: g,
            cls: "administration_plugin_tree " + (m.treeCls || ""),
            region: "west",
            title: m.treeTitle || "",
            width: 200,
            split: m.split === false ? false : true,
            margins: m.split === false ? "3 6 3 3" : "3 0 3 3",
            root: h,
            tbar: e
        });
    ...
    Signavio.Extensions.AdminPanel = function (b) {
        ...
        this.onStoreChange = (b.onStoreChange || function () {}).bind(this);
        this.onSelectionChange = (b.onSelectionChange || function () {}).bind(this);
    ...
    Ext.extend(Signavio.Extensions.AdminPanel, Ext.Panel, {
        layout: "border",
        margins: "3 3 3 3",
        generateFormPanel: function (b) {
            return new Signavio.Extensions.FormStorePanel({
                region: "center",
                autoScroll: true,
                cls: "configuration_window_form",
                margins: "3 3 3 0",
                items: b,
                bodyStyle: "overflow-x:hidden;",
                hideButtons: this.hideButtons || false
            })
        }
    })
}();
...
Signavio.Extensions.DrawerButtons = function (a) {
    ...
    var b = function (m, l, j) {
        var k = Signavio.Core.graft("http://www.w3.org/1999/xhtml", null, ["a", {
            "class": "x-btn"
        }]);
...
Signavio.Extensions.HoverButton = function (b) {
    ...
    var e = function () {
        this.view.getEl().on("mouseover", f, this, {
            delegate: b.selector
        });
        this.view.getEl().on("mouseout", a, this, {
            delegate: b.selector
        })
    };
    var f = function (k, l) {
...
Ext.extend(Signavio.Extensions.FormStorePanel, Ext.form.FormPanel, {
    defaults: {
        width: 200
    },
    getDirtyEl: function () {
        return Signavio.Core.graft("http://www.w3.org/1999/xhtml", null, ["div", {
            "class": "x-grid3-dirty-cell x-dirty-cell-overlay"
        }])
    },
    ...
    initFields: function () {
        ...
        var g = function (j, h, k) {
            ...
            this.ok.show(true);
            window.setTimeout(this.ok.hide.bind(this.ok, {
                useDisplay: true
            }), f);
            j.un("update", g, this);
        ...
        this.commitBtn = new Ext.Button({
            text: Signavio.I18N.Repository.FormStorePanel.commit,
            disabled: true,
        ...
        this.rejectBtn = new Ext.Button({
            text: Signavio.I18N.Repository.FormStorePanel.reject,
            disabled: true,
            hidden: this.hideButtons,
            handler: function () {
        ...
        var a = new Ext.Panel({
            border: false,
            disable: this.disable.bind(a),
            enable: this.enable.bind(a),
            autoWidth: true,
            style: this.labelWidth !== undefined ? "padding-left:" + (this.labelWidth + 5) + "px" : "",
            cls: "x-admin-btn",
            items: ([this.commitBtn, this.rejectBtn])
        });
...
Ext.extend(Signavio.Extensions.TreeLoader, Ext.tree.TreeLoader, {
    ...
    initStoreEvents: function (a, b, e) {
        ...
        this.cachedCallbacks[d] = {
            update: this.doResponse.bind(this, a, b, e),
            add: this.onAdd.bind(this, b),
            remove: this.onRemove.bind(this, b)
        };
    ...
    generateNodeData: function (d, b, e) {
        ...
        var a = b.map(function (h) {
            ...
            var j = {
                text: Signavio.I18N.Repository.Folder[h.get("rep").type] || (f.parseText ? f.parseText(k, h) : false) || k || f.value,
                cls: f.childCls || (f.hasChildCls ? f.hasChildCls(h) : ""),
                leaf: f.childLeaf || (f.isChildLeaf ? f.isChildLeaf(h) : false),
                childLeaf: f.childLeaf,
                isChildLeaf: f.isChildLeaf,
                filterFn: f.filterFn,
                checked: f.checked ? e.ui.isChecked() : (f.checked === false ? e.ui.isChecked() : undefined),
                hasChildCls: f.hasChildCls,
                parseText: f.parseText instanceof Function ? f.parseText : undefined,
                childCls: f.childCls,
                dataField: f.dataField,
                recordRel: f.recordRel,
                singleClickExpand: f.singleClickExpand || false,
                getIdentifier: f.getIdentifier instanceof Function ? f.getIdentifier : undefined,
                getToolTip: f.getToolTip instanceof Function ? f.getToolTip : undefined,
                identifier: f.getIdentifier instanceof Function ? f.getIdentifier(h) : h.get("href")
            };
            if (this.showTooltip) {
...
Signavio.Extensions.TreePanel = function (b) {
    b = b || {};
    b.loader = new Signavio.Extensions.TreeLoader({
        panel: this,
        sortingFn: b.sortingFn
    });
...
Ext.extend(Signavio.Extensions.TreePanel, Ext.tree.TreePanel, {
    animate: true,
    enableDD: false,
    rootVisible: false,
    useArrows: true,
...
Ext.extend(Signavio.Extensions.TreeCheckPanel, Signavio.Extensions.TreePanel, {
    animate: true,
    autoScroll: true,
    enableDD: false,
    rootVisible: false,
    ...
    loadData: function () {
        var a = function (e, b) {
            e = e.map(function (d) {
                return Ext.apply(Object.clone(this.defaultItem), (typeof d == "string" ? {
                    text: d,
                    identifier: d
                } : (this.dataLabel ? {
                    text: d[this.dataLabel],
                    identifier: d[this.dataLabel]
                } : d)))
            }.bind(this));
...
Ext.extend(Signavio.Extensions.TreeTableView, Signavio.Extensions.TreePanel, {
    cls: "x-tableview-plugin",
    autoWidth: true,
    animate: true,
    border: false,
    onLoad: function (a, b, d) {
        this.root.collapse();
        this.dirty = true;
...
Ext.extend(Signavio.Extensions.ModelDirectoryCheckTreePanel, Signavio.Extensions.TreePanel, {
    ...
    expandToAndCheckPreSelection: function (a) {
        ...
        a.each(function (f) {
            ...
            if (h) {
                [].concat(g === f ? {
                    href: g.getIdentifier()
                } : [], h.get("rep")).reverse().each(function (k, j) {
                    if (!d[j]) {
                        d[j] = []
                    }
...
Ext.extend(Signavio.Extensions.ProcessMapCheckTreePanel, Signavio.Extensions.TreePanel, {
    style: "padding:0px;padding-top:10px;",
    anchor: "100% -15",
    cls: "x-tableview-plugin",
    forceUpdate: true,
    recordRel: [Signavio.Const.REL.MODEL],
    onDestroy: function () {
...
Ext.extend(Signavio.Extensions.HoverPanel, Ext.Panel, {
    border: false,
    title: "&nbsp;",
    cls: "x-info",
    bodyStyle: "margin-left:9px;background:white;",
    collapsible: true,
    layout: "border",
    offsetTop: 28,
...
new function () {
    ...
    Ext.extend(Signavio.Extensions.ViewSelectionWindow, Ext.Window, {
        resizable: false,
        minimizable: false,
        modal: true,
        width: 345,
        defaultButton: 0,
        title: Signavio.I18N.Repository.Offer.WindowTitle,
        bodyStyle: "background-color:white;",
        layout: "form",
        buttons: [{
            text: Signavio.I18N.Repository.Offer.WindowBtnExport,
            handler: function () {
                this.ownerCt.onSubmit();
                this.ownerCt.close()
            }
        }, {
            text: Signavio.I18N.Repository.Offer.WindowBtnCancel,
            handler: function () {
                this.ownerCt.close()
            }
        }],
        ...
        initComponent: function () {
            ...
            this.items = this.views.map(function (b) {
                return new Ext.form.Radio({
                    ctCls: "y-export-radio",
                    name: a,
                    hideLabel: true,
                    boxLabel: b.rep.name,
                    href: b.href.replace("/info", "")
                })
            });
            this.items.unshift(new Ext.form.Radio({
                ctCls: "y-export-radio-original",
                name: a,
                hideLabel: true,
                boxLabel: Signavio.I18N.Repository.Revision.resetView,
                href: this.modelId,
                checked: true
            }));
            this.items.unshift(new Ext.form.Label({
                cls: "y-export-window-description",
                text: Signavio.I18N.Repository.Offer.WindowDescription
            }));
...
new function () {
    ...
    Signavio.Helper.GetAllCountries = function () {
        return [{
            ...
            id: "GS",
            name: "South Georgia & The S. Sandwich Is"
        }, {
            id: "ES",
            name: "Spain"
        }, {
    ...
    Signavio.Helper.HashUtils = {
        callbacks: [],
        interval: 100,
        useIFrame: Ext.isIE && (Signavio.Helper.isIE6() || Signavio.Helper.isIE7()),
...
new function () {
    ...
    Signavio.Core.ViewPlugin = {
        renderToView: "view",
        viewGroup: null,
        viewIcons: {
            icon: Signavio.Config.EXPLORER_PATH + "/src/img/nuvola/16x16/actions/view_icon.png",
            table: Signavio.Config.EXPLORER_PATH + "/src/img/nuvola/16x16/actions/view_text.png"
        },
        _doRender: function () {
            this.beforeRender();
            this.render();
...
new function () {
    var a = [];
    Signavio.Core.AdministrationPlugins = {
        construct: function () {
            arguments.callee.$.construct.apply(this, arguments);
            a.push(this)
        },
...
new function () {
    ...
    Signavio.Core.StoreManager.getRootDirectoryStore = function (b) {
        return Signavio.Core.StoreManager.getStore("root") || Signavio.Core.StoreManager.getRelatedStore(Signavio.Config.DIRECTORY_PATH, "root", ["dir", "glos"], {
            callback: b
        })
    };
    Signavio.Core.StoreManager.loadChildEntitiesStore = function (b) {
        Signavio.Core.StoreManager.getRelatedStore(b, "child", ["mod", "dir"], {
            sort: Signavio.Helper.BusinessObjectSortingFunction
        })
    };
    ...
    Signavio.Core.StoreManager.getAllUserStore = function (b) {
        return Signavio.Core.StoreManager.getRelatedStore(Signavio.Config.USER_PATH, undefined, undefined, b instanceof Function ? {
            callback: b
        } : undefined)
    };
    ...
    Signavio.Core.StoreManager.getAllGroupStore = function (b) {
        return Signavio.Core.StoreManager.getRelatedStore(Signavio.Config.USERGROUP_PATH, "usergroups", undefined, b instanceof Function ? {
            callback: b
        } : undefined)
    };
    Signavio.Core.StoreManager.getStore = function (b, d, e) {
        if (d === true) {
            return Signavio.Core.StoreManager.getRelatedStore(b, undefined, undefined, {
                callback: e
            })
        } else {
            return a.get(b)
    ...
    Signavio.Core.StoreManager.getRelatedStore = function (h, e, g, f) {
        ...
        if (!d) {
            if ((h || "").startsWith(Signavio.Config.USERGROUP_PATH)) {
                d = new Signavio.Core.UserGroupStore({
                    url: ""
                })
            } else {
                if ((h || "").startsWith(Signavio.Config.TENANT_PATH)) {
                    ...
                    if ((h || "").startsWith(Signavio.Config.MODEL_PATH)) {
                        d = new Signavio.Core.ModelStore({
                            url: ""
                        })
                    } else {
                        d = new Signavio.Core.DataStore({
                            url: ""
                        })
                    }
                }
...
new function () {
    ...
    a.doAdd = function (h, j) {
        ...
        d.doRequest(k, [l, g], Ext.apply((Object.clone(h.get("rep")) || {}), {
            parent: m
        }), "post")
    };
    ...
    Signavio.Core.DataStore = function (f) {
        Signavio.Core.DataStore.superclass.constructor.call(this, Ext.apply(f, {
            ...
            reader: new Ext.data.JsonReader(f, ["rel", "href", "rep"])
        }));
    ...
    Ext.extend(Signavio.Core.DataStore, Ext.data.Store, {
    ...
    Signavio.Core.ModelStore = Ext.extend(Signavio.Core.DataStore, {
    ...
    Signavio.Core.UserGroupStore = Ext.extend(Signavio.Core.DataStore, {
        addAsParent: function (f) {
    ...
    Signavio.Core.Repository = {
        ...
        getFacade: function () {
            return {
                ...
                isCurrentUserInGroup: function (id) {
                ...
                raiseEvent: this._eventManager.raiseEvent.bind(this._eventManager),
                registerOnEvent: this._eventManager.registerOnEvent.bind(this._eventManager),
                unregisterOnEvent: this._eventManager.unregisterOnEvent.bind(this._eventManager),
                registerInitializeFinal: function (callback) {
                    this._additionalFinializeCount += 1;
                    this._additionalFinalClb.push(callback)
                }.bind(this),
                releaseInitializeFinal: function () {
                    this.finialize()
                }.bind(this)
            }
        },
        ...
        noFeaturesAvailable: function () {
            Ext.Msg.show({
                title: Signavio.I18N.Repository.noFeaturesTitle,
                msg: Signavio.I18N.Repository.noFeaturesMsg,
        ...
        _initStores: function (fn) {
            ...
            RM.doRequest(url, [
                ...
                function (result) {
                    Ext.Msg.show({
                        title: "Signavio",
                        msg: Signavio.I18N.Repository.loadingFailed,
                        buttons: {
                            ok: "Reload"
                        },
                        fn: function () {
                        ...
                        icon: Ext.MessageBox.WARNING,
                        width: 300
                    }).getDialog().syncSize().el.setStyle("z-index", 1000000)
                }.bind(this)
            ], null, "get")
        },
        _initUser: function (store) {
            ...
            Signavio.Templates.header.overwrite(this._controls.headerPanel.body, {
                user: this._userName,
                isTestSystem: this.config.isTestSystem,
                isGuest: isGuest
            });
            if (isGuest) {
                ...
                if (form) {
                    form.dom.onsubmit = function (e) {
                        ...
                        var w = new Ext.Window({
                            ...
                            resizable: false,
                            width: 325,
                            title: Signavio.I18N.Repository.Header.loginTitle,
                            items: [new Ext.form.FormPanel({
                                ...
                                items: [new Ext.form.TextField({
                                    fieldLabel: Signavio.I18N.Repository.Header.windowFieldName,
                                    width: 290,
                                    tabIndex: 1000,
                                    name: "name",
                                    value: ($("name") || {}).value || "",
                                    ...
                                    fieldLabel: Signavio.I18N.Repository.Header.windowFieldPassword,
                                    width: 290,
                                    inputType: "password",
                                    tabIndex: 1001,
                                    name: "password",
                                    ...
                                    boxLabel: Signavio.I18N.Repository.Header.windowFieldRemember,
                                    labelSeparator: "",
                                    tabIndex: 1002,
                                    onRender: function (ct, position) {
                            ...
                            buttons: [new Ext.LinkButton({
                                text: Signavio.I18N.Repository.Header.windowBtnResetPassword,
                                click: function () {
                                    var ww = new Ext.Window({
                                        ...
                                        layout: "form",
                                        modal: true,
                                        title: Signavio.I18N.Repository.Header.windowBtnResetPassword,
                                        items: [new Ext.form.Label({
                                            text: Signavio.I18N.Repository.Header.windowResetPasswordDesc,
                                            style: "width:200px;display:block;padding-bottom:10px;"
                                        }), new Ext.form.TextField({
                                            emptyText: Signavio.I18N.Repository.Header.windowFieldName,
                                            width: 200,
                                            hideLabel: true
                                        })],
                                        buttons: [{
                                            text: Signavio.I18N.Repository.Header.windowBtnSend,
                                            handler: function () {
                                                var mail = (this.ownerCt.items.get(1).getValue() || "").trim();
                                                if (!mail) {
                                                    return
                                                }
                                                RM.doPost(Signavio.Config.RESET_PASSWORD_PAGE, [
                                                    function () {
                                                        ww.close();
                                            ...
                                            text: Signavio.I18N.Repository.Header.windowBtnCancel,
                                            handler: function () {
                                                this.ownerCt.close()
                                            },
                                            tabIndex: 1004
                                ...
                                text: Signavio.I18N.Repository.Header.windowBtnLogin,
                                tabIndex: 1003,
                                handler: function () {
                                    ...
                                    var params = {
                                        ...
                                        remember: form.items.get(2).getValue() ? "on" : undefined,
                                        tokenonly: true
                                    };
                                    RM.doPost(Signavio.Config.LOGIN_PAGE, [
                                        function (result) {
                                            form.submit()
                                        },
                                        function (e) {
        ...
        _initComponents: function () {
            ...
            this._controls.leftPanel = new Ext.Panel({
                ...
                width: 250,
                border: false,
                hidden: !! Signavio.Config.HideLeftPanel,
                autoScroll: true
            });
            this._controls.rightPanel = new Ext.Panel({
                region: "east",
                cls: "right_view",
                title: Signavio.I18N.Repository.rightPanelTitle,
                header: false,
                layout: "card",
                collapsible: true,
                collapsed: true,
                ...
                width: 290,
                autoScroll: true,
                plugins: [new Signavio.Extensions.DrawerButtons()]
            });
            ...
            this._controls.toolbarPanel = new Ext.Toolbar({
                region: "south",
                cls: "north_view",
                border: false,
                height: 28
            });
            this._controls.headerPanel = new Ext.Panel({
                region: "center",
                cls: "header_view",
                html: Signavio.Templates.header.apply({
                    user: "",
                    isTestSystem: false
                }),
                border: false
            });
            this._controls.topPanel = new Ext.Panel({
                region: "north",
                layout: "border",
                cls: "north_view",
                height: 63,
                border: false,
                items: [this._controls.headerPanel, this._controls.toolbarPanel]
            });
            this._controls.viewport = new Ext.Viewport({
                layout: "border",
                margins: "0 0 0 0",
                defaults: {},
                border: false,
                items: [this._controls.topPanel, this._controls.viewPanel, this._controls.leftPanel]
            });
            this._controls.viewport.doLayout();
            this._controls.hoverPanel = {
                height: 70,
...
var abStore;
new function () {
    Signavio.Plugins.Search = {
        renderToView: "toolbar",
        enabled: true,
        render: function () {
            this.panel = new Ext.Panel({
                ...
                items: [new Ext.Panel({
                    ...
                    value: "",
                    id: "search_plugin_field",
                    emptyText: Signavio.I18N.Repository.Offer.search,
                    width: 100,
                    listeners: {
                        specialkey: function (d, f) {
        ...
        doSearch: function () {
            ...
            Signavio.Core.StoreManager.getRelatedStore("/search", "child", ["mod", "dir"], {
                force: true,
                params: {
                    q: a,
                    offset: 0,
                    limit: Signavio.Config.SEARCH_LIMIT
                }
            });
    ...
    Signavio.Plugins.New = {
        ...
        construct: function () {
            ...
            this.facade.offer({
                cls: "x-menu-large",
                group: "new",
                name: Signavio.I18N.Repository.Offer.newTitle,
                icon: Signavio.Config.EXPLORER_PATH + "/src/img/nuvola/16x16/actions/filenew.png",
                isVisible: function () {
                    return !this.selectionInTrash() && !this.selectionInSearch()
                }.bind(this),
                isDisabled: a,
                items: [{
                    name: Signavio.I18N.Repository.Offer.newFolderTitle,
                    description: Signavio.I18N.Repository.Offer.newFolderDescription,
                    seperated: true,
                    activeClass: "x-menu-item-active item-large",
                    iconCls: "x-menu-item-icon-large",
                    cls: "x-menu-list-item-large",
                    icon: Signavio.Config.EXPLORER_PATH + "/src/img/signavio/new_folder.png",
                    functionality: this.createFolder.bind(this)
                }],
                onAdd: function (d) {
                    this.menuButton = d;
            ...
            if (this.facade.isSupportedBrowserEditor()) {
                this.facade.offer({
                    relGroup: "edit",
                    index: 0,
                    name: Signavio.I18N.Repository.Offer.edit,
                    description: Signavio.I18N.Repository.Offer.editDescription,
                    icon: Signavio.Config.EXPLORER_PATH + "/src/img/nuvola/16x16/actions/pencil.png",
                    isDisabled: function () {
                        return this.selectionInTrash() || !this.oneSelected()
                    }.bind(this),
                    neededPrivileges: [Signavio.Config.RIGHTS.WRITE],
                    functionality: function () {
                        var d = Signavio.Config.EDITOR_HANDLER_URI + "?" + Object.toQueryString({
                            id: this.getSelection()[0].get("href").split("/")[2]
                        });
                        window.open(d)
                    }.bind(this)
                })
            ...
            this.facade.loadStencilSets(function (d) {
                ...
                d.each(function (e) {
                    ...
                    var f = {
                        text: e["title_" + b] || e.title,
                        tooltip: e["description_" + b] || e.description,
                        activeClass: "x-menu-item-active item-large",
                        iconCls: "x-menu-item-icon x-menu-item-icon-large",
                        cls: "x-menu-list-item-large",
                        icon: Signavio.Config.EXPLORER_PATH + "/src/img" + e.icon_url,
                        handler: this.createModel.bind(this, Signavio.Config.BACKEND_PATH + "/editor?stencilset=" + e.namespace.replace(/#/g, "%23"))
                    };
                    if (!this.menuButton) {
                        if (!this.cacheButtons) {
                            this.cacheButtons = []
        ...
        createFolder: function () {
            var a = Ext.Msg.prompt(Signavio.I18N.Repository.Offer.newWindowFolderTitle, Signavio.I18N.Repository.Offer.newWindowFolderDesc, function (d, f) {
                if (d === "ok") {
                    ...
                    var e = Signavio.Core.RecordCreator.create(Signavio.Const.REL.DIRECTORY, null, {
                        name: f,
                        description: ""
                    });
                    b.add(e, true)
        ...
        createModel: function (b) {
        	// this browser switch does not work for modern browsers and makes no more sense in 2013
            // if (this.facade.isSupportedBrowserEditor()) {
...
new function () {
    Signavio.Plugins.Update = {
        enabled: true,
        construct: function () {
            arguments.callee.$.construct.apply(this, arguments);
            this.facade.offer({
                name: Signavio.I18N.Repository.Offer.updateTitle,
                arrange: "right",
                description: Signavio.I18N.Repository.Offer.updateDescription,
                icon: Signavio.Config.EXPLORER_PATH + "/src/img/nuvola/16x16/actions/reload.png",
                functionality: this.update.bind(this)
            })
        },
        update: function () {
    ...
    Signavio.Plugins.Delete = {
        ...
        construct: function () {
            ...
            this.facade.offer({
                relGroup: "edit",
                index: 6,
                name: Signavio.I18N.Repository.Offer.deleteTitle,
                description: Signavio.I18N.Repository.Offer.deleteDescription,
                icon: Signavio.Config.EXPLORER_PATH + "/src/img/famfamfam/page_white_remove.png",
                functionality: this.deleteElements.bind(this),
                isDisabled: function () {
                    return this.noneSelected()
                }.bind(this),
                isVisible: this.selectionNotInTrash.bind(this),
                seperated: true,
                neededPrivileges: [Signavio.Config.RIGHTS.DELETE]
            });
            this.facade.offer({
                name: Signavio.I18N.Repository.Offer.removeTitle,
                description: Signavio.I18N.Repository.Offer.removeDescription,
                icon: Signavio.Config.EXPLORER_PATH + "/src/img/famfamfam/page_white_remove.png",
                functionality: this.removeElements.bind(this),
                isDisabled: function () {
                    return this.noneSelected()
                }.bind(this),
                isVisible: this.selectionInTrash.bind(this),
                neededPrivileges: [Signavio.Config.RIGHTS.DELETE]
            });
            this.facade.offer({
                name: Signavio.I18N.Repository.Offer.restoreTitle,
                description: Signavio.I18N.Repository.Offer.restoreDescription,
                icon: Signavio.Config.EXPLORER_PATH + "/src/img/nuvola/16x16/actions/restore.png",
                functionality: this.recoverElements.bind(this),
                isDisabled: function () {
                    return this.noneSelected()
                }.bind(this),
                isVisible: this.selectionInTrash.bind(this),
...
new function () {
    Signavio.Plugins.Move = {
        enabled: true,
        construct: function () {
            arguments.callee.$.construct.apply(this, arguments);
            this.facade.offer({
                group: "edit",
                name: Signavio.I18N.Repository.Offer.editGroupTitle,
                icon: Signavio.Config.EXPLORER_PATH + "/src/img/nuvola/16x16/apps/package_utilities.png",
                isVisible: this.selectionNotInTrash.bind(this),
                items: [{
                    relGroup: "edit",
                    index: 3,
                    ...
                    relGroup: "edit",
                    index: 4,
                    name: Signavio.I18N.Repository.Offer.moveTitle,
                    description: Signavio.I18N.Repository.Offer.moveDescription,
                    icon: Signavio.Config.EXPLORER_PATH + "/src/img/famfamfam/page_white_go.png",
                    functionality: this.doMove.bind(this, true),
                    isDisabled: function () {
                    ...
                    relGroup: "edit",
                    index: 5,
                    name: Signavio.I18N.Repository.Offer.copyTitle,
                    description: Signavio.I18N.Repository.Offer.copyDescription,
                    icon: Signavio.Config.EXPLORER_PATH + "/src/img/famfamfam/page_white_copy.png",
                    functionality: this.doMove.bind(this, false),
                    isDisabled: function () {
                        return this.selectionInTrash() || !this.manySelected()
                    }.bind(this),
                    neededPrivileges: [Signavio.Config.RIGHTS.READ]
                }]
            })
        },
        doMove: function (a) {
        ...
        showWindow: function (j, b) {
            ...
            if (this.getSelection().length === 1) {
                h = new Template(Signavio.I18N.Repository.Offer[(b ? "move" : "copy") + "WindowHeader"]).evaluate({
                    title: this.getSelection()[0].get("rep").name
                })
            } else {
                h = new Template(Signavio.I18N.Repository.Offer[(b ? "move" : "copy") + "WindowHeaderMultiple"]).evaluate({
                    count: this.getSelection().length
                })
            }
            ...
            var g = new Signavio.Extensions.ModelDirectoryCheckTreePanel({
                height: 270,
                style: "padding:0px;",
                disabledIds: this.getSelection().map(function (k) {
                    return k.get("href")
                }),
            ...
            g.loader = new Signavio.Extensions.TreeLoader({
                panel: g,
                sortingFn: g.sortingFn,
                generateNodeData: function (m, p, n) {
            ...
            var a = new Ext.Window({
                modal: true,
                cls: "x-plugin-move-window",
                title: Signavio.I18N.Repository.Offer[(b ? "move" : "copy") + "Title"],
                resizable: false,
                width: 400,
                items: [new Ext.form.Label({
                    text: h
                ...
                buttons: [{
                    text: Signavio.I18N.Repository.Offer[(b ? "move" : "copy") + "BtnOk"],
                    handler: function () {
                    ...
                    text: Signavio.I18N.Repository.Offer.moveBtnCancel,
                    handler: function () {
                        a.close()
                    }
                }]
    ...
    Signavio.Plugins.Folder = {
        ...
        render: function () {
            ...
            this.panel = new Ext.tree.TreePanel({
                ...
                pathSeparator: "#",
                useArrows: true,
                loader: new Signavio.Extensions.TreeLoader({
                    showTooltip: true
                }),
                lines: false,
                border: false,
        ...
        onFoldersUpdate: function (b, g) {
            ...
            var e = b.map(function (j) {
                ...
                return j.get("rep").type == Signavio.Config.FOLDER_TYPE.TRASH && j.get("rep").visible === false ? undefined : {
                    text: k,
                    type: j.get("rep").type,
                    cls: "folder",
                    leaf: false,
                    identifier: j.get("href"),
                    rel: j.get("rel"),
                    cls: l ? "x-glossary" : "folder",
                    dataField: "rep.name",
                    leaf: j.get("rep").type == "trash" || l,
                    isChildLeaf: function (m) {
        ...
        getSelectionPath: function (a) {
            ...
            while (d.parentNode && d !== this.panel.root) {
                b.unshift({
                    ...
                    name: d.attributes.text,
                    store: Signavio.Core.StoreManager.getStore(d.attributes.identifer)
                });
                d = d.parentNode
            }
            return b
...
new function () {
    Signavio.Plugins.Toolbar = {
        renderToView: "toolbar",
        enabled: true,
        relTypes: [Signavio.Const.REL.PRIVILEGE],
        construct: function () {
            arguments.callee.$.construct.apply(this, arguments);
                    ...
                    if (offer.group) {
                        ...
                        if (offer.seperated && !offer.functionality) {
                            ...
                            var button = new Ext.Toolbar.Button({
                                handler: offer.functionality,
                                iconCls: "class_bugfixing",
                                icon: offer.icon,
                                disabled: true,
                                toggleGroup: offer.toggleGroup,
                                enableToggle: !! offer.toggleGroup,
                                allowDepress: !offer.toggleGroup,
                                pressed: offer.pressed,
                                text: offer.name,
...
new function () {
    Signavio.Plugins.Message = {
        ...
        onLog: function (e, d) {
            ...
            var a = Signavio.Core.graft("http://www.w3.org/1999/xhtml", this.panel.body, ["div", {
                    "class": "x-message-item"
                },
                d.message
            ]);
            a = Ext.get(a).boxWrap();
...
var abStore;
new function () {
    Signavio.Plugins.Breadcrumb = {
        enabled: true,
        viewGroup: ["icon", "table"],
        lastUrl: "",
        render: function () {
        ...
        onFolderSelectionChange: function (b, a) {
            this.bread = a.map(function (d) {
                return {
                    href: d.identifier,
                    name: d.name,
                    fn: "Signavio.Core.StoreManager.loadChildEntitiesStore( (event.target||event.srcElement).getAttribute('rel') )"
                }
            });
            this.cachedBread = []
        },
        ...
        update: function (a) {
            ...
            if (this.panel.bottombar && this.panel.bottombar.parent()) {
                ...
                if (b) {
                    this.panel.bottombar = b.createChild({
                        html: "",
                        cls: "x-breadcrumb-bottom-bar"
                    })
                }
        ...
        updateSearch: function (h, l) {
            ...
            var k = new Ext.XTemplate(Signavio.I18N.Repository.BreadCrumb.nrOfResults).apply({
                nr: Math.max(m, 0)
            });
            ...
            this.bread = [{
                name: h + " (" + k + ")",
                delimiter: "" + Signavio.I18N.Repository.BreadCrumb.search,
                fn: "Signavio.Core.StoreManager.getRelatedStore( '/search', 'child', ['dir', 'mod'], {force:true,params:" + Object.toJSON(l.lastOptions.params).gsub('"', "'") + "})"
            }];
            if (this.lastUrl) {
                ...
                this.bread.unshift({
                    href: this.lastUrl,
                    delimiter: "&laquo; ",
                    name: Signavio.I18N.Repository.BreadCrumb.goBack,
                    fn: "Signavio.Core.StoreManager.loadChildEntitiesStore( (event.target||event.srcElement).getAttribute('rel') )"
                })
            }
            ...
            if (m > j && l.lastOptions && l.lastOptions.params) {
                ...
                [this.panel.content, this.panel.bottombar].compact().each(function (n) {
                    var e = n.createChild({
                        html: String.format("{0} {1}/{2} {3}", b, g + 1, a + 1, d),
                        tag: "span",
                        cls: "x-bread-search-pages"
                    });
        ...
        getBreadCrumb: function (a) {
            ...
            if (d) {
                this.bread.push({
                    href: a.getIdentifier(),
                    name: Signavio.I18N.Repository.Folder[d.get("rep").type] || d.get("rep").name || d.get("rep").title || a.getIdentifier(),
                    fn: "Signavio.Core.StoreManager.loadChildEntitiesStore( (event.target||event.srcElement).getAttribute('rel') )"
                })
            }
            ...
            if (b) {
                b.get("rep").each(function (e) {
                    this.bread.unshift({
                        href: e.href,
                        name: Signavio.I18N.Repository.Folder[e.rep.type] || e.rep.name || e.rep.title || e.href,
                        fn: "Signavio.Core.StoreManager.loadChildEntitiesStore( (event.target||event.srcElement).getAttribute('rel') )"
                    })
                }.bind(this))
            }
    ...
    Signavio.Plugins.IconView = {
        ...
        render: function () {
            ...
            this.panel = new Ext.DataView({
                store: Signavio.Core.StoreManager.getChildEntitiesStore(),
                tpl: Signavio.Templates.View,
                cls: "view_plugin",
                multiSelect: true,
        ...
        onDblClick: function (b, m, g, p) {
            ...
            if (l.get("rel") === Signavio.Const.REL.DIRECTORY) {
                ...
                if (l.get("rel") === Signavio.Const.REL.MODEL) {
                    if (!Ext.isIE) {
                        var q = Signavio.Config.EDITOR_HANDLER_URI + "?" + Object.toQueryString({
                            id: l.get("href").split("/")[2]
                        });
                        window.open(q)
                    } else {
...
var abStore;
new function () {
    Signavio.Plugins.Info = {
        renderToView: "hover",
        enabled: true,
        relTypes: ["info", "revision"],
        render: function () {
            this.panel = new a({
                view: this,
                plugins: [new Ext.DataView.LabelEditor({
                    labelSelector: "span.x-editable",
                    onSave: this.onValueChange.bind(this, true)
                }), new Ext.DataView.LabelEditor({
                    labelSelector: "div.x-editable",
                    onSave: this.onValueChange.bind(this, false),
                    tag: "textarea",
                    grow: false,
                    listeners: {
                        beforestartedit: function (b) {
        ...
        openEditor: function (b) {
            ...
            var d = Signavio.Config.EDITOR_PATH + "?" + Object.toQueryString({
                id: b.get("href").split("/")[2]
            });
            window.open(d)
        },
    ...
    Ext.extend(a, Ext.Panel, {
        ...
        onRender: function () {
            ...
            Signavio.Core.graft("http://www.w3.org/1999/xhtml", this.body.dom, ["div", {
                "class": "x-info-details"
            }]);
            Signavio.Core.graft("http://www.w3.org/1999/xhtml", this.body.dom, ["div", {
                    "class": "x-info-model",
                ...
                ["img", {
                    "class": "x-msg-loading",
                    style: "display:none;",
                    src: Signavio.Config.LIBS_PATH + "/ext-2.0.2/resources/images/default/tree/s.gif"
                }]
            ]);
            ...
            this.img.showImg = function (e) {
                if (!this.img.imgs[e]) {
                    var d = Ext.get(Signavio.Core.graft("http://www.w3.org/1999/xhtml", this.img, ["img", {
                        src: e,
        ...
        updateSingleModel: function (d, j) {
            ...
            h.info = new Template(Signavio.I18N.Repository.Info.Attributes.info).evaluate({
                time: h.bDate,
                user: h.authorName
            });
        ...
        updateRootFolder: function (b) {
            var d = {
                name: Signavio.I18N.Repository.Folder[b.get("rep").type] || b.get("rep").name
            };
        ...
        updateMultipleElements: function (e) {
            ...
            if (b.length > 1) {
                b = new Template(Signavio.I18N.Repository.Info.Attributes.infoMulipleTwo).evaluate({
                    time: b[0],
                    time2: b[1]
                })
            } else {
                b = new Template(Signavio.I18N.Repository.Info.Attributes.infoMulipleOne).evaluate({
                    time: b[0]
                })
            }
            Signavio.Templates.InfoMultiple.overwrite(this.details, {
                count: e.length,
                updated: b
            })
        },
